...
/**
 * @Description: 用于跟ES索引库交互的POJO
 * @Author:      Zeki
 * @CreateDate:  2020/1/7 0007 下午 10:12
 */
...
public class SkuInfo implements Serializable {
     ...
     * store = false：是否存储
     * searchAnalyzer = "ik_smart"：搜索时所用的分词器
     */
    ...
    //规格
    private String spec;  // "{ "尺寸" : "4.5", "尺码":"180" }"

    //规格参数
    private Map<String,Object> specMap;  // 把spec转成Map存进来，规格也要作为索引
